var Weglot = (function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
      ...
      const periodText = priceText.querySelector('.period');

      toggle.addEventListener('change', () => {
        if (toggle.checked) {
          priceText.innerHTML = '$39.99 <span class="period">/Yearly (billed annually)</span>';
        } else {
          priceText.innerHTML = '$49.99 <span class="period">/Monthly</span>';
        }
      });
    });
