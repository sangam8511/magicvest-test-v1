var Weglot = (function () {
  ...
  var g = {
      ddtags: "env:prod,version:5.60.0",
  ...
  var v = h({ service: "html-parser-engine" });
  function m(e, t, n) {
    var r = t && t[e];
  ...
  function b(e) {
    try {
      if (u.mergedSelectorRemove && T(e, u.mergedSelectorRemove)) return !1;
    } catch (e) {}
    return (
  ...
  function E(e) {
    return (
      !!e && (!(!("wgNoTranslate" in e) || !e.wgNoTranslate) || E(e.parentNode))
    );
  }
  function S(e) {
    if (!e) return !1;
    var t = e.closest ? e : e.parentNode;
    return !(!t || !T(t, "[" + u.noTranslateAttribute + "]")) || E(e);
  }
  var C = function (e, t) {
      return function (n, r) {
        try {
  ...
  function j(e) {
    ...
    if (!t) return [];
    if ((W(t), !u.whitelist || !u.whitelist.length))
      return [].concat(
        (function (e) {
          var t = document.getElementsByTagName("title")[0];
          if (e !== document.documentElement || !document.title || !t || S(t))
            return [];
          return [
            {
    ...
    var n = u.whitelist
      ...
      .join(",");
    if (T(t, n)) return R(t);
    for (var r = [], a = 0, o = O(t, n); a < o.length; a += 1) {
      var i = o[a];
      [].push.apply(r, R(i));
    }
    return r;
    ...
    return [].concat(
      ...
      (function (e) {
        var t,
          ...
          a = document.createTreeWalker(e, 4, P, !1);
        for (; (t = a.nextNode()); ) {
          var o = (
            r && (b(t.parentNode) || t.parentNode.childNodes.length > 1) ? I : D
          )(t, a);
          o && n.push(o);
        }
        return n;
  ...
  function P(e) {
    return !w(e) || S(e) ? NodeFilter.FILTER_REJECT : NodeFilter.FILTER_ACCEPT;
  }
  function I(e, t) {
    var n = (function (e) {
    ...
    if (a) {
      var o = a[0],
        ...
        l = a[2];
      if (!H(i))
        return A.set(o, a), { element: o, words: i, type: 1, properties: l };
    }
  }
  function D(e) {
    var t = e.textContent;
    if (!H(t)) return { element: e, words: t, type: 1, properties: {} };
  }
  function F(e, t) {
    e.wgNoTranslate =
      !u.private_mode ||
  ...
  function W(e) {
    ...
    if (t && t.length) {
      var n = t.map(function (e) {
        ...
        r = n.join(",");
      N(e, r) ? F(e, n) : (e.wgNoTranslate = !1);
      for (var a = 0, o = O(e, r); a < o.length; a += 1) {
        F(o[a], n);
      }
      M(e, r);
  ...
  function q(e, t) {
    for (var n = 0, r = e; n < r.length; n += 1) {
      var a = r[n],
        o = a.weglot.content;
      if (o && a.isConnected) {
        for (var i = 0, l = o; i < l.length; i += 1) {
          var s = l[i],
            c = s.original,
            d = s.properties,
            f = s.attrSetter,
            g = s.translations,
            p = g[t] || c;
          (t === u.language_from || (g[t] && c !== g[t])) &&
            (d && ((a.weglot.isSet = !0), z(a, p, d, c, e)),
            f && ((a.weglot.isSet = !0), f(a, p, c)));
        }
        a.wgResolved = !1;
      }
    }
  ...
  function z(e, t, n, r, a) {
    if (1 === e.nodeType) {
      ...
      return (
        (e.innerHTML = ""), e.appendChild(o), void (e.wgSetHTML = e.outerHTML)
      );
    }
    if (!L(t) || L(r)) return (e.textContent = t), void (e.wgSetHTML = t);
    if (!e.parentNode)
      return (
        v.warn(
          "Unable to translate some words, please contact support@weglot.com."
        ),
        void v.warn(e, { sendToDatadog: !1 })
      );
    if (1 === e.parentNode.childNodes.length)
      return (
        (e.parentNode.weglot = e.weglot),
        void (a ? a.push(e.parentNode) : z(e.parentNode, t, n, r))
      );
    var i =
    ...
    if (!i || i.innerHTML !== t) {
      ...
      (l.dataset.wgTranslationWrapper = ""),
        ...
        a ? a.push(l) : z(e.parentNode, t, n, r);
    }
  }
  function B(e, t, n) {
    ...
    for (var a = t.childNodes.length, o = 0; o < a; o++) {
      ...
      if ((i = $(l))) {
        ...
        (u.innerHTML = ""),
          u.appendChild(c),
          r.appendChild(u),
          document.createDocumentFragment().appendChild(l),
          (s.used = !0);
  ...
  function X(e) {
    var t = [
      { type: 1, selectors: ["[title]"], attribute: V("title") },
      {
        type: 2,
      ...
      { type: 7, selectors: ["img"], attribute: V("alt") },
      {
        type: 8,
    ...
    if (
      (e.media_enabled &&
        t.push(
          ...
          { type: 6, selectors: ["img"], attribute: V("srcset") }
        ),
      e.translate_aria &&
        t.push({
          type: 1,
          selectors: ["[aria-label]"],
          attribute: V("aria-label"),
        }),
      e.external_enabled)
    ) {
      var n = J(
      ...
      t.push(
        { type: 10, selectors: ["iframe"], attribute: V("src") },
        { type: 10, selectors: ["a[rel=external]"], attribute: V("href") },
        { type: 10, selectors: ['[href^="mailto"]'], attribute: V("href") },
        { type: 10, selectors: ['[href^="tel"]'], attribute: V("href") },
        {
          type: 10,
    ...
    return (
      ...
      t.merged_selectors_remove &&
        (u.mergedSelectorRemove = t.merged_selectors_remove
          ...
          .join(",")),
      { getTextNodes: j, setTextNodes: q, definitions: (Y = X(u)) }
    );
  }
  function Z(e) {
  ...
  var te = h({ service: "js-library" }),
    ne = "wgVeExtension",
    re = "getCurrentLanguage",
    ae = "setCurrentLanguage",
    oe = "languageChanged",
    ie = "library",
    le = "extension",
    se = "https://cdn.weglot.com/projects-settings/",
    ue = "preview.weglot.io",
    ce = "wglang",
    de = "wg-style-trans",
    ...
    ke = ["none", "shiny", "square", "circle", "rectangle_mat"],
    xe = {};
  !(function (e) {
    var t = (function () {
        try {
  ...
  var Fe = {},
    Me = function (e, t) {
      Fe[e] || (Fe[e] = []), Fe[e].push(t);
    },
    We = function (e, t) {
      if (Fe[e])
        for (var n = 0, r = Fe[e]; n < r.length; n += 1) {
          (0, r[n])(t);
        }
    };
  var Ue = [];
  ...
  function qe(e, t, n) {
    return "function" != typeof t
      ? (te.error("You should provide a callback function as second argument", {
          sendToDatadog: n,
        }),
        !1)
      : !n && we.indexOf(e) < 0
      ? (te.error("No Weglot event is named " + e, { sendToDatadog: !1 }), !1)
      : (Ue.push({ name: e, callback: t, internal: n }), !0);
  }
  function ze(e) {
    for (var t = [], n = arguments.length - 1; n-- > 0; )
      t[n] = arguments[n + 1];
    for (
      var r = Ue.filter(function (t) {
          return t.name === e;
        }),
        a = 0,
        o = r;
      ...
      try {
        ...
        te.error("Error triggering callback function: " + e, {
          sendToDatadog: !1,
        });
      }
    }
  ...
  function Be() {
    ...
    if (t && t.editorCurrentURL) {
      var n = new Ee(t.editorCurrentURL),
        r = n.hostname,
        a = n.pathname,
        i = n.search;
      return { url: document.baseURI, hostname: r, pathname: a, search: i };
    }
    te.error("Problem finding editor page location", { sendToConsole: !1 });
    var l = new Ee(document.baseURI),
      s = l.hostname,
      u = l.pathname,
      c = l.search;
    return { url: document.baseURI, hostname: s, pathname: u, search: c };
  }
  He(Ao && Object.keys(Ao).length > 0, "onOptionsReady", function () {
    if (Ao.dynamicPushState) {
      var e = history.pushState;
      history.pushState = function () {
        for (var t = [], n = arguments.length; n--; ) t[n] = arguments[n];
        e.apply(history, t), ze("onCurrentLocationChanged");
      };
    }
  });
  var $e,
  ...
  function Je(e) {
    void 0 === e && (e = null), (e = e || Be().pathname);
    var t = Ao.localeRules;
    void 0 === t && (t = []);
    var n = Ao.languages,
      r = Ao.prevent_default_locale_rule;
    void 0 === r && (r = !1);
    var a = {
        position: 0,
    ...
    var s = null,
      ...
      d = c || a;
    return (
      (Ve.convertLocale = function (t, n, a, i) {
        if (
          (void 0 === n && (n = e),
          void 0 === a && (a = s || o),
          void 0 === i && (i = null),
          !n.startsWith("/") || (!c && r) || a === t)
        )
          return n;
        var l = d.position;
        void 0 === l && (l = 0);
        var f = d.originalFormat;
        void 0 === f && (f = "");
        var g = d.translatedFormat;
        void 0 === g && (g = "CODE");
        var p = n.split("/");
        if (p.length <= l) return n;
        var _ = p[l + 1];
        if (a === o) {
          var h = g.replace(/CODE/g, t),
            v = !1;
          if (f) {
            var m = f.replace(/CODE/g, o),
              y = new RegExp("^" + m + "$", "g"),
              w = Ge(h);
            (h = _.replace(y, w)),
              i && !y.test(_) && ((v = !0), (h = i.split("/")[l + 1]));
          }
          var b = f && !v ? 2 : 1;
          return p
            .slice(0, l + 1)
            .concat([h], p.slice(l + b))
            .join("/");
        }
        if (t === o && !f)
          return p
            ...
            .concat(p.slice(l + 2))
            .join("/");
        var k = Ge((t === o ? f : g).replace(/CODE/g, t)),
          x = _.replace(u, k);
        return p
          .slice(0, l + 1)
          .concat([x], p.slice(l + 2))
          .join("/");
      }),
      (Ve.language = s || o),
      Ve
  ...
  function Xe() {
    var e = Be().hostname,
      t = Ao.languages.find(function (t) {
        return (
          t.connect_host_destination && t.connect_host_destination.host === e
        );
      });
    return t ? t.custom_code || t.language_to : Ao.language_from;
  }
  function Ye() {
    return Je().language;
  }
  function Ke(e) {
    ...
    if (t) {
      ...
      for (var n = 0, r = e; n < r.length; n += 1) {
        var a = r[n];
        if (a.slice(0, 2) === t.slice(0, 2)) return a;
      }
      return null;
    }
  }
  function Ze() {
    ...
    if (Ao.is_connect) {
      ...
      return e ? (($e = e), e) : ($e = Ao.subdirectory ? Ye() : Xe());
    }
    if ("WordPress" === Ao.technology_name) {
      var t = Ke(
        Ao.languages.map(function (e) {
          return e.language_to;
        })
      );
      if (t) return t;
    }
    return ($e = Ao.language_from);
  }
  function Qe(e, t) {
    var n = t;
    n || (n = Ze());
  ...
  var et = {
      ...
      removeItem: function (e) {
        return ee.erase({ name: e, options: Ao });
      },
    },
    tt = {
      getItem: function () {},
  ...
  function nt(e) {
    ...
    var t = e.type || "local";
    try {
      return "cookie" === t ? et : window[t + "Storage"];
    } catch (e) {}
    return e.type ? tt : nt({ type: "local" === t ? "cookie" : "local" });
  }
  var rt = { slugs: {}, version: 0, network: void 0 };
  function at() {
  ...
  function it(e) {
    ...
    if (t && t.slugTranslation) {
      ...
      rt.version < n &&
        (rt.network
          ? rt.network.resolved ||
            rt.network.then(function (t) {
              return e(ot(t));
            })
          : (rt.network = at()
              .then(function (t) {
                return (
                  (rt.network.resolved = !0),
                  (function (e) {
                    var t = Ao.versions,
                      n = { version: t ? t.slugTranslation : 1, slugs: e };
                    try {
                      var r = nt({ type: "local" });
                      r && r.setItem(ve, JSON.stringify(n));
                    } catch (e) {
                      te.warn(e);
                    }
                    rt = Object.assign({}, rt, n);
                  })(t),
                  e(ot(t)),
                  t
                );
  ...
  function lt(e) {
    if (e && e.toLowerCase) {
      var t = e.toLowerCase(),
        n = Ao.languages.find(function (e) {
          var n = e.language_to,
            r = e.custom_code;
  ...
  !(function () {
    if (Object.keys(rt.slugs).length) return rt.slugs;
    try {
      var e = nt({ type: "local" });
      if (!e) return {};
      var t = e.getItem(ve);
      t && (Object.assign(rt, JSON.parse(t)), rt.slugs);
    } catch (e) {
      return {};
    }
  })();
  ...
  function ct(e, t) {
    (Ao.auto_switch || Ao.geo_auto_switch) &&
      (Ao.is_tld || Ao.rendered) &&
      (e === Ao.language_from
  ...
  function dt(e, t, n) {
    ...
    if ((void 0 === n && (n = null), n))
      try {
        r = new Ee(n, window.location.origin);
      } catch (e) {
        return n;
      }
    else
      (r = new Ee(Be().url)),
        Ao.visual_editor &&
          r.searchParams.has("url") &&
          (r = new Ee(r.searchParams.get("url"))),
        r.searchParams.has("lang") && r.searchParams.delete("lang"),
        ct(e, r);
    var a = (function (e) {
      if (Ao.subdirectory) return !1;
      var t = Ao.language_from,
        n = Ao.host,
        r = Ao.languages;
      if (e === t) return n;
      var a =
    ...
    return (
      ...
      (r.pathname = (function (e, t, n, r) {
        ...
        if ((st[t] || (st[t] = {}), !st[t].originalPath))
          if (n !== Ao.language_from && e[n]) {
            var a = e[n].translated;
            st[t].originalPath = ut(t, a);
          } else st[t].originalPath = t;
        return r === Ao.language_from
          ? st[t].originalPath
          : e[r] && e[r].original
          ? ut(st[t].originalPath, e[r].original)
          : t;
      })(t, r.pathname, Ze(), e)),
      Ao.subdirectory &&
        e &&
        (r.pathname = Je(r.pathname).convertLocale(e, r.pathname)),
      r.toString()
    );
  }
  function ft(e, t) {
    if ("WordPress" === Ao.technology_name && !Ao.is_connect) {
      if (Ao.injectedData && Ao.injectedData.switcher_links) {
        var n = lt(e);
        return t(Ao.injectedData.switcher_links[n]);
      }
      var r = (function (e) {
      ...
      return r
        ? t(r)
        : (te.error("No switcher_links or hreflang elements found.", {
            sendToDatadog: !1,
          }),
          t("#"));
    }
    if (!Ao.is_connect || !e) return t("#");
    var a = Ao.dynamicPushState,
      o = Ao.injectedData;
    void 0 === o && (o = {});
    var i = o.allLanguageUrls;
    if ((void 0 === i && (i = {}), !a && i && i[e])) {
      var l = new Ee(i[e]);
      return ct(e, l), t(l.toString());
    }
    it(function (n) {
      return t(dt(e, n));
    });
  ...
  function _t() {
    ...
    if (e) {
      ...
      (1 !== t.length && t[0] === t[1]) ||
        ee.set({ name: "cart", value: t[0], domain: pt(), options: Ao });
    } else setTimeout(_t, 100);
  }
  function ht(e) {
    var t =
      "/checkout?locale=" +
      e +
      (Ao.shopify_skip_shop_pay ? "&skip_shop_pay=true" : "");
    fetch(t)
      .then(function (e) {
    ...
    [
      ...
      for (
        var a = e.name,
          ...
          i = e.testRegex,
          l = e.event,
          s = document.querySelectorAll(o.join(",")),
          u = function () {
            var e = d[c],
              o = e.getAttribute(a);
            if (
      ...
      o =
        ...
        document.querySelector(
          'form[action="' +
            ((t = a),
            (n = "/account"),
            (Ao.is_connect && t !== Ao.language_from
              ? gt[n]
                ? gt[n]
                : (it(function (e) {
                    var a = e && e[t] ? ut(n, e[t].original) : n;
                    r = Ao.subdirectory
                      ? Je().convertLocale(t, a, Ao.language_from)
                      : a;
                  }),
                  (gt[n] = r),
                  r)
        ...
        ("string" == typeof Ao.customer_tag && Oe(document, Ao.customer_tag));
    if (o) {
  ...
  function wt(e) {
    ...
    t &&
      ee.set({ name: "checkout_locale", value: mt(e), path: t, options: Ao });
  }
  function bt(e) {
    var t = e || Ze();
    if (!Ao.visual_editor && !Ae()) {
      var n = Ao.cart_attributes,
        r = Ao.is_connect,
        a = Ao.original_shopify_checkout,
        o = Ao.subdirectory,
        i = Ao.language_from,
        l =
          nt({ type: "cookie" }).getItem("cart") &&
          decodeURIComponent(nt({ type: "cookie" }).getItem("cart")),
        s =
          nt({ type: "session" }).getItem("wg-cart-update-token") &&
          decodeURIComponent(
            nt({ type: "session" }).getItem("wg-cart-update-token")
          ),
        u = nt({ type: "session" }).getItem("wg-cart-update-lang");
      if (n && n.length && (u !== mt(t) || l !== s)) {
        var c = n
            .map(function (e) {
              return "attributes[" + e + "]=" + mt(t);
            })
            .join("&"),
        ...
        !1 !== a &&
          ...
          nt({ type: "session" }).setItem("wg-cart-update-token", l),
          nt({ type: "session" }).setItem("wg-cart-update-lang", mt(t));
      }
      for (
        ...
        var h = _[p],
          v = h.getAttribute("href");
        if (v) {
          var m = v.match(/\/cart\/\d+:\d+(\?)?/);
          m &&
            ((v = v.replace(/&?attributes\[lang\]=([a-zA-Z-]+)/g, "")),
            h.setAttribute("href", v + (m[1] ? "&" : "?") + g));
        }
      }
    }
  }
  function kt(e) {
    if (Ao.language_from !== e) {
      window.Shopify &&
        ((window.Shopify.locale = e), !je() && Ao.order_tag && bt(e)),
        vt(e),
        wt(e);
      var t = document.querySelectorAll("[data-wg-only-display]");
      t.length && Qe(t, e), Ao.customer_tag && yt(e);
    }
  }
  qe(
    "onCurrentLocationChanged",
  ...
  function Ct(e, t) {
    var n = Ao.excluded_paths;
    if (!n || !n.length) return !1;
    if (
      ((t = (function (e) {
        return (
          e ||
          (Ao.injectedData && Ao.injectedData.originalPath
            ? Ao.injectedData.originalPath
            : Be().pathname)
        );
      })(t).toLowerCase()),
      (e = lt(e || Ze())),
    ...
    var r = (function (e, t) {
      ...
      if ("string" == typeof n)
        return n.split(",").some(function (e) {
          ...
          ? { allExcluded: !0, language_button_displayed: !0 }
          : null;
      ...
      return r
        ? {
            ...
            allExcluded:
              !r.excluded_languages ||
              !r.excluded_languages.length ||
              r.excluded_languages.length >= Ao.languages.length,
          }
        : null;
    })(e, t);
    return (Et[t][e] = r), r;
  ...
  function Ot() {
    ...
    if (!Ao.api_key)
      return (
        te.warn("Weglot must be initialized to use it.", { sendToDatadog: !1 }),
        []
      );
    var e = (Ao.languages || [])
        .filter(function (e) {
          var t = Ct(e.language_to),
            n = !t || t.language_button_displayed;
          return (
            (!1 !== e.enabled || Ao.private_mode) &&
            n &&
            (Ao.subdirectory ||
              !Ao.is_connect ||
      ...
      t = [Ao.language_from].concat(e);
    return (
      (xt = t.filter(function (e, n) {
        return e && t.indexOf(e) == n;
      })),
      e.length ||
        te.log("No public language available.", { sendToDatadog: !1 }),
      xt
    );
  }
  function Nt() {
    var e = nt().getItem(ce);
    if (e && Ot().includes(e)) return e;
  }
  qe(
    "onCurrentLocationChanged",
    function () {
  ...
  try {
    Object.keys(Rt).forEach(function (e) {
      Object.keys(Rt[e]).forEach(function (t) {
        Object.keys(Rt[e][t]).forEach(function (n) {
          if (2 === n.length) {
            Pt[e] || (Pt[e] = {}), Pt[e][n] || (Pt[e][n] = {});
            var r = Rt[e][t][n];
            Pt[e][n][r] = t;
          }
        });
  ...
  function Dt(e, t) {
    return !(!Pt[Ao.api_key] || !Pt[Ao.api_key][t]) && Pt[Ao.api_key][t][e];
  }
  function Ft(e) {
    return Rt[Ao.api_key] && Rt[Ao.api_key][e];
  }
  function Mt() {
    try {
      At.setItem(Lt, JSON.stringify(jt)), At.setItem(he, JSON.stringify(Rt));
    } catch (e) {}
  }
  var Wt = [
      {
  ...
  function zt(e, t) {
    ...
    if ("INTEGRATION" === n)
      return (
        ("proxy" === r && Ao.is_connect) ||
        ("javascript" === r && !Ao.is_connect)
      );
    if ("DOM_CONTAINS" === n) {
      var a = r.selector;
      if (Oe(document, a)) return !0;
    }
    return "IN_FRAME" === n
      ? r === ("with-window-top" === Ae())
      : ("object" == typeof r &&
          "selector" in r &&
          ["XML_ATTRIBUTE_VALUE", "XML_ROOT_ELEMENT_NAME"].includes(n),
        !1);
  }
  var Bt = function (e, t) {
    var n = t.type,
  ...
  function $t() {
    var e = (function () {
      if (Ao.visual_editor) return new Ee(Be().url);
      var e = Ao.technology_name,
        t = Ao.injectedData;
      if (e === me.wix.name) return new Ee(window.location.href);
      if (t && t.originalCanonicalUrl)
        try {
          return new Ee(t.originalCanonicalUrl);
        } catch (e) {}
      var n = document.querySelector("link[rel='canonical'][href]");
      if (n)
        try {
          return new Ee(n.href);
        } catch (e) {}
      return new Ee(window.location.href);
    })();
    Ao.disable_remove_numeric_slugs ||
    ...
    for (
          ...
          return (e = []).concat
            .apply(
              ...
              Wt.filter(function (e) {
                return !(t = e.technology_id) || t === Ao.technology_id;
                var t;
              })
                .map(function (e) {
                  return e.urls;
                })
                .concat([(Ao.definitions && Ao.definitions.urls) || []])
            )
            .filter(function (e) {
              return qt(e.condition);
            });
      ...
      try {
        ...
        te.warn(e, { consoleOverride: "Invalid URL regex, " + e.stack });
      }
    }
    return e.toString();
  }
  ...
  function Gt(e, t) {
    ...
    var n,
      ...
      a = e.l_to,
      o = e.words,
      i = Ao.visual_editor || t.search,
      l =
        !i &&
        ((n = jt[Ao.api_key]),
        (r = n && n === Ao.versions.translation) ||
          (delete Rt[Ao.api_key],
          delete jt[Ao.api_key],
          delete Pt[Ao.api_key],
          Mt()),
        r);
    if (!o || !o.length)
    ...
    return s && s.isComplete
      ? Promise.resolve(s.words)
      : (function (e) {
          var t,
            n = (Ao.versions && Ao.versions.translation) || 1,
            r = ["api_key=" + Ao.api_key, "v=" + n],
            a =
              "https://" +
              (Ao.bypass_cdn_api ? "api.weglot.com" : "cdn-api-weglot.com") +
              "/translate?" +
              r.join("&"),
            o = Ao.previewHash ? { "weglot-source": "preview" } : {};
          return fetch(a, {
            method: "POST",
            body:
              ((t = JSON.stringify(e)),
              t.replace(/[\u007F-\uFFFF]/g, function (e) {
                return (
                  "\\u" + ("0000" + e.charCodeAt(0).toString(16)).substr(-4)
                );
              })),
            headers: o,
          })
            ...
            .then(function (e) {
              if (!e || !e.to_words)
                throw (
                  (te.warn(e, { sendToDatadog: !1 }),
                  Error("An error occurred, please try again later"))
                );
              return e;
            });
        })(Object.assign({}, e, { request_url: $t(), l_to: lt(a) })).then(
          function (e) {
            return (
              i ||
                o.forEach(function (t, n) {
                  ...
                  (r = t.w),
                    ...
                    (s = Ft(r))
                      ? (s[i] = o)
                      : (Rt[Ao.api_key] || (Rt[Ao.api_key] = {}),
                        (Rt[Ao.api_key][r] = (((l = {})[i] = o), l))),
                    Pt[Ao.api_key] || (Pt[Ao.api_key] = {}),
                    Pt[Ao.api_key][i] || (Pt[Ao.api_key][i] = {}),
                    (Pt[Ao.api_key][i][o] = r),
                    (jt[Ao.api_key] = Ao.versions.translation),
                    Ie(Mt)();
                }),
              e
            );
  ...
  function Jt(e, t, n) {
    ...
    var r = { l_from: Ao.language_from, l_to: t, words: e };
    return n.title && (r.title = document.title), Gt(r, n);
  }
  function Xt(e, t) {
    if ("string" != typeof e || "function" != typeof t) return !1;
    var n = Ze();
    return n === Ao.language_from
      ? (t(e), !1)
      : (Gt(
          { l_from: lt(n), l_to: Ao.language_from, words: [{ t: 2, w: e }] },
          { search: !0 }
        )
          .then(function (e) {
          ...
          return function (t) {
            ...
            if (i) {
              var d = l.content.find(function (e) {
                ...
                f = { attrSetter: i, original: r, type: a, translations: s };
  ...
  function an(e) {
    for (var t = [], n = 0, r = e; n < r.length; n += 1) {
      var a = r[n];
      -1 === Kt.indexOf(a) && t.push(a);
    }
    return [].push.apply(Kt, t), t;
  }
  function on(e, t) {
    void 0 === e && (e = Kt), void 0 === t && (t = {});
    var n = Ao.prevent_retranslation,
      r = Ao.injectedData;
    void 0 === r && (r = {});
    var a = Ao.is_connect;
    if (n && a && !Qt) {
        ...
        for (var l = 0, s = i[o].weglot.content || {}; l < s.length; l += 1) {
          ...
          if (-1 !== f && !d[t]) {
            var g =
              (p = a[f]) &&
              p.replace &&
              p.replace(/wg-(\d+)=""(\s*)\/(\s*)>/g, 'wg-$1="">');
            Ao.prevent_retranslation && tn(g), (d[t] = g);
          }
        }
    var p;
    try {
  ...
  function sn(e) {
    var t = Ao.language_from,
      ...
      o = Ao.host,
      i = Ao.languages;
    if (n === _e) return "https://" + ge + "/" + r + "/" + t + "/" + e + "/";
    if (a) return "https://" + o + "/" + e + "/" + "wg-cgi/";
    var l = i.find(function (e) {
      return e.custom_code === Ze() || e.language_to === Ze();
    });
    return l
      ? "https://" + l.connect_host_destination.host + "/" + "wg-cgi/"
      : null;
  }
  var un = [];
  function cn(e) {
    ...
    var r = Ao.proxify_iframes,
      a = Ao.api_key,
      o = Ao.language_from;
    if (r && r.length && Array.isArray(r))
      for (var i = 0, l = Ce(n, r.join(",")); i < l.length; i += 1) {
        var s = l[i],
          u = s.src;
        if (u)
          if (
            (s.weglot || (s.weglot = {}),
            u.includes(ge + "/") || u.includes("/wg-cgi/"))
          )
            if (t && t !== o) {
            ...
            if (
              (s.weglot.originalFrameSrc || (s.weglot.originalFrameSrc = u),
              t === o)
            )
              continue;
            try {
  ...
  function dn(e) {
    void 0 === e && (e = Ze()),
      (function (e) {
        void 0 === e && (e = Ze());
        for (
          var t = { message: "Weglot.setLanguage", payload: e }, n = 0, r = un;
          n < r.length;
          n += 1
        ) {
          var a = r[n];
    ...
    if (e.data && "null" !== e.origin) {
      ...
      if (n) {
        if ("Weglot.iframe" === n) {
          ...
          return e.source.postMessage(a, e.origin), void un.push(e.source);
        }
        "Weglot.setLanguage" !== n || ho(r);
      }
    }
  }
  var gn,
  ...
  function Ln(e, t, n) {
    ...
    if (
      (arguments.length > 2 &&
        (i.children = arguments.length > 3 ? gn.call(arguments, 2) : n),
      "function" == typeof e && null != e.defaultProps)
    )
      for (o in e.defaultProps) void 0 === i[o] && (i[o] = e.defaultProps[o]);
    return An(e, i, r, a, null);
  }
  function An(e, t, n, r, a) {
    ...
    return null == a && null != pn.vnode && pn.vnode(o), o;
  }
  function jn(e) {
    return e.children;
  }
  ...
  function Pn(e, t) {
    if (null == t) return e.__ ? Pn(e.__, e.__i + 1) : null;
  ...
  function Dn(e) {
    ((!e.__d && (e.__d = !0) && hn.push(e) && !Fn.__r++) ||
      vn !== pn.debounceRendering) &&
      ((vn = pn.debounceRendering) || mn)(Fn);
  }
  function Fn() {
    var e, t, n, r, a, o, i, l;
    for (hn.sort(yn); (e = hn.shift()); )
      e.__d &&
        ((t = hn.length),
        (r = void 0),
        (o = (a = (n = e).__v).__e),
  ...
  function Mn(e, t, n, r, a, o, i, l, s, u, c) {
    ...
    for (
            ...
            (i = r + d),
              ...
              (a = e.__k[r] =
                ...
                "function" == typeof a
                  ...
                  ? An(null, a, null, null, null)
                  : On(a)
                  ? An(jn, { children: a }, null, null, null)
                  : void 0 === a.constructor && a.__b > 0
                  ? An(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v)
                  : a)
                ? ((a.__ = e),
                  (a.__b = e.__b + 1),
                  (l = Hn(a, n, i, c)),
      ...
      null != (g = n.__k[d]) &&
        "boolean" != typeof g &&
        "function" != typeof g &&
        ((f = -1 === g.__i ? En : h[g.__i] || En),
        (g.__i = d),
        $n(e, g, f, a, o, i, l, s, u, c),
        (p = g.__e),
        g.ref &&
          f.ref != g.ref &&
          (f.ref && Jn(f.ref, null, g), c.push(g.ref, g.__c || p, g)),
        null == _ && null != p && (_ = p),
        65536 & g.__u || f.__k === g.__k
          ? (s && "string" == typeof g.type && !e.contains(s) && (s = Pn(f)),
            (s = Wn(g, s, e)))
  ...
  function Hn(e, t, n, r) {
    ...
    if (
      null === s ||
      (s && a == s.key && o === s.type && 0 == (131072 & s.__u))
    )
      return n;
    if (r > (null != s && 0 == (131072 & s.__u) ? 1 : 0))
      for (; i >= 0 || l < t.length; ) {
        if (i >= 0) {
          if ((s = t[i]) && 0 == (131072 & s.__u) && a == s.key && o === s.type)
            return i;
          i--;
        }
        if (l < t.length) {
          if ((s = t[l]) && 0 == (131072 & s.__u) && a == s.key && o === s.type)
            return l;
          l++;
        }
      }
  ...
  function qn(e, t, n) {
    "-" === t[0]
      ...
      : (e[t] =
          null == n ? "" : "number" != typeof n || Cn.test(t) ? n : n + "px");
  }
    ...
    e: if ("style" === t)
      if ("string" == typeof n) e.style.cssText = n;
        ...
        if (("string" == typeof r && (e.style.cssText = r = ""), r))
          for (t in r) (n && t in n) || qn(e.style, t, "");
        if (n) for (t in n) (r && n[t] === r[t]) || qn(e.style, t, n[t]);
      }
    else if ("o" === t[0] && "n" === t[1])
      (o = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, "$1"))),
        ...
        n
          ? r
            ? (n.u = r.u)
            : ((n.u = wn), e.addEventListener(t, o ? kn : bn, o))
          : e.removeEventListener(t, o ? kn : bn, o);
    else {
  ...
  function Bn(e) {
    return function (t) {
      if (this.l) {
        ...
        return n(pn.event ? pn.event(t) : t);
      }
    };
  }
  function $n(e, t, n, r, a, o, i, l, s, u) {
    var c,
      d,
      f,
      g,
    ...
    128 & n.__u && ((s = !!(32 & n.__u)), (o = [(l = t.__e = n.__e)])),
      (c = pn.__b) && c(t);
    e: if ("function" == typeof C)
      try {
        if (
          ...
          m &&
            ...
            (d.__s == d.state && (d.__s = Nn({}, d.__s)),
            Nn(d.__s, C.getDerivedStateFromProps(v, d.__s))),
          (g = d.props),
          (p = d.state),
          (d.__v = t),
          f)
        ...
        (d.state = d.__s),
          null != d.getChildContext && (r = Nn(Nn({}, r), d.getChildContext())),
          m &&
            !f &&
            null != d.getSnapshotBeforeUpdate &&
            (_ = d.getSnapshotBeforeUpdate(g, p)),
          Mn(
            e,
            On(
              (S =
                null != c && c.type === jn && null == c.key
                  ? c.props.children
                  : c)
            )
              ? S
        ...
        (t.__v = null),
          s || null != o
            ? ((t.__e = l), (t.__u |= s ? 160 : 32), (o[o.indexOf(l)] = null))
      ...
      null == o && t.__v === n.__v
        ...
        : (t.__e = Gn(n.__e, t, n, r, a, o, i, s, u));
    (c = pn.diffed) && c(t);
  }
  function Vn(e, t, n) {
    t.__d = void 0;
  ...
  function Gn(e, t, n, r, a, o, i, l, s) {
    ...
    if (null == e) {
      ...
      (e = document.createElementNS(a, m, v.is && v)), (o = null), (l = !1);
    }
    if (null === m) h === v || (l && e.data === v) || (e.data = v);
    else {
      if (
        ((o = o && gn.call(e.childNodes)), (h = n.props || En), !l && null != o)
      )
        for (h = {}, u = 0; u < e.attributes.length; u++)
          h[(g = e.attributes[u]).name] = g.value;
      for (u in h)
        if (((g = h[u]), "children" == u));
        else if ("dangerouslySetInnerHTML" == u) d = g;
        else if ("key" !== u && !(u in v)) {
          if (
  ...
  function Xn(e, t, n) {
    ...
    if ((r = e.__k))
      for (a = 0; a < r.length; a++)
        r[a] && Xn(r[a], t, n || "function" != typeof e.type);
    ...
    (Rn.prototype.setState = function (e, t) {
      ...
      (n =
        null != this.__s && this.__s !== this.state
          ? this.__s
          : (this.__s = Nn({}, this.state))),
        "function" == typeof e && (e = e(Nn({}, n), this.props)),
        e && Nn(n, e),
  ...
  var Zn,
    ...
    cr = ar.__;
  function dr(e, t) {
    ar.__h && ar.__h(Qn, e, nr || t), (nr = 0);
    var n = Qn.__H || (Qn.__H = { __: [], __h: [] });
    ...
    return (
      ...
      (function (e, t, n) {
        ...
        if (
          ...
          Qn.u = !0;
          var o = Qn.shouldComponentUpdate,
            i = Qn.componentWillUpdate;
          (Qn.componentWillUpdate = function (e, t, n) {
            if (this.__e) {
              var r = o;
  ...
  function gr(e, t) {
    var n = dr(Zn++, 3);
    !ar.__s && wr(n.__H, t) && ((n.__ = e), (n.i = t), Qn.__H.__h.push(n));
  }
  function pr(e) {
    return (
      (nr = 5),
      (function (e, t) {
        var n = dr(Zn++, 7);
        return wr(n.__H, t) && ((n.__ = e()), (n.__H = t), (n.__h = e)), n.__;
      })(function () {
        return { current: e };
      }, [])
    );
  ...
  function _r() {
    for (var e; (e = rr.shift()); )
      if (e.__P && e.__H)
        try {
          e.__H.__h.forEach(mr), e.__H.__h.forEach(yr), (e.__H.__h = []);
        } catch (t) {
          (e.__H.__h = []), ar.__e(t, e.__v);
        }
  }
  (ar.__b = function (e) {
    (Qn = null), or && or(e);
    ...
    (ar.__r = function (e) {
      ...
      t &&
        (er === Qn
          ...
          : (t.__h.forEach(mr), t.__h.forEach(yr), (t.__h = []), (Zn = 0))),
        (er = Qn);
    }),
    (ar.diffed = function (e) {
      lr && lr(e);
      var t = e.__c;
      t &&
        t.__H &&
        (t.__H.__h.length &&
          ((1 !== rr.push(t) && tr === ar.requestAnimationFrame) ||
            ((tr = ar.requestAnimationFrame) || vr)(_r)),
  ...
  var hr = "function" == typeof requestAnimationFrame;
  function vr(e) {
    var t,
      n = function () {
        clearTimeout(r), hr && cancelAnimationFrame(t), setTimeout(e);
      },
      r = setTimeout(n, 100);
    hr && (t = requestAnimationFrame(n));
  }
  function mr(e) {
    var t = Qn,
      n = e.__c;
    "function" == typeof n && ((e.__c = void 0), n()), (Qn = t);
  }
  function yr(e) {
    var t = Qn;
    (e.__c = e.__()), (Qn = t);
  ...
  ((Er.prototype = new Rn()).isPureReactComponent = !0),
    (Er.prototype.shouldComponentUpdate = function (e, t) {
  ...
  (pn.unmount = function (e) {
    var t = e.__c;
    t && t.__R && t.__R(), t && 32 & e.__u && (e.type = null), Nr && Nr(e);
  }),
    ((Ar.prototype = new Rn()).__c = function (e, t) {
      var n = t.__c,
        r = this;
    ...
    (Ar.prototype.componentWillUnmount = function () {
      this.t = [];
    }),
    (Ar.prototype.render = function (e, t) {
      ...
      var a = t.__a && Ln(jn, null, e.fallback);
      return a && (a.__u &= -33), [Ln(jn, null, t.__a ? null : e.children), a];
    });
  ...
  ((Rr.prototype = new Rn()).__a = function (e) {
    var t = this,
      n = jr(t.__v),
      r = t.o.get(e);
    return (
      ...
      function (a) {
        var o = function () {
          t.props.revealOrder ? (r.push(a), Pr(t, e, r)) : a();
        };
        n ? n(o) : o();
      }
    );
  ...
  var Ir =
    ...
    Fr = /^on(Ani|Tra|Tou|BeforeInp|Compo)/,
    Mr = /[A-Z0-9]/g,
    Wr = "undefined" != typeof document,
    Ur = function (e) {
      return (
  ...
  pn.event = function (e) {
    return (
      Hr && (e = Hr(e)),
      (e.persist = qr),
      (e.isPropagationStopped = zr),
      (e.isDefaultPrevented = Br),
      (e.nativeEvent = e)
    );
  };
  var $r = {
    ...
    "string" == typeof e.type &&
      (function (e) {
        ...
        for (var a in t) {
          ...
          if (
            !(
              ("value" === a && "defaultValue" in t && null == o) ||
              (Wr && "children" === a && "noscript" === n) ||
              "class" === a ||
              "className" === a
            )
          ) {
            ...
            "defaultValue" === a && "value" in t && null == t.value
              ...
              ? "onfocus" === i
                ...
                : Fr.test(a)
                ? (a = i)
                : -1 === n.indexOf("-") && Dr.test(a)
                ? (a = a.replace(Mr, "-$&").toLowerCase())
                : null === o && (o = void 0)
              : (i = a = "oninput"),
        ...
        "select" == n &&
          ...
          (r.value = Un(t.children).forEach(function (e) {
          ...
          t.class && !t.className
            ? ((r.class = t.class), Object.defineProperty(r, "className", $r))
        ...
        var o = (function (e, t) {
          function n(e) {
            ...
            return (
              ...
              t ? !t(this.props, e) || !r : xr(this.props, e)
            );
          }
          function r(t) {
            return (this.shouldComponentUpdate = n), Ln(e, t);
          }
          return (
          ...
          (function (e) {
            ...
            var u = (function (e, t) {
              ...
              c = u,
              d = (function (e) {
                var t = Qn.context[e.__c],
                  n = dr(Zn++, 9);
                return (
                  (n.c = e),
                  t
                    ? (null == n.__ && ((n.__ = !0), t.sub(Qn)), t.props.value)
                    : e.__
                );
              })(Xr);
            return Ln(
  ...
  function Zr(e) {
    ...
    var r = e.children,
      a = (function (e) {
        ...
        return (
          (t.__ = e),
          Qn.componentDidCatch ||
            (Qn.componentDidCatch = function (e, r) {
              t.__ && t.__(e, r), n[1](e);
            }),
          [
            n[0],
  ...
  var Qr = ["text_active", "text_inactive", "text_hover"],
    ea = ["bg_active", "bg_inactive", "bg_hover"],
    ta = [
      {
        name: "default",
        editorDropdown: !0,
      ...
      {
        name: "toggle",
        editableProps: ["hide_selected_language"].concat(Qr, ea),
        defaultValues: {
          style: { full_name: !1 },
      ...
      },
      {
        ...
        editorDropdown: !1,
        editableProps: ["open_hover", "close_outside_click"].concat(Qr, ea),
        defaultValues: {
          style: {
            with_name: !0,
            with_flags: !1,
      ...
      {
        name: "underline_edge",
        editableProps: ["full_name", "hide_selected_language"].concat(Qr),
        maxLanguages: 10,
        minLanguages: null,
        defaultValues: {
          style: { full_name: !1 },
  ...
  var ra = h({ service: "switcher-templates" });
  var aa = {
      ...
      ca: { name: "Català", flag: "es-ca", rtl: !1 },
      ...
      eu: { name: "Euskara", flag: "eus", rtl: !1 },
      ...
      my: { name: "မျန္မာစာ", flag: "mm", rtl: !1 },
  ...
  function ia(e) {
    ...
    var t = oa.find(function (t) {
      return t.previous === e;
    });
    t && (e = t.new);
    var n = e.toLowerCase(),
      r = Ao.languages.find(function (e) {
        var t = e.language_to,
          r = e.custom_code;
    ...
    return r && r.custom_local_name
      ...
      : r && r.custom_name
      ? r.custom_name
      : n === Ao.language_from && Ao.language_from_custom_name
      ? Ao.language_from_custom_name
      : aa[n]
      ? aa[n].name
      : "Unknown";
  }
  function la(e, t) {
    var n = oa.find(function (t) {
      return t.previous === e;
    });
  ...
  function sa(e) {
    return (function (e, t, n) {
      ...
      if (t.language_from === e) return t.language_from_custom_flag || la(e, n);
      var r = e.toLowerCase(),
      ...
      return a ? a.custom_flag || la(a.language_to, n) : "";
    })(e, Ao, aa);
  }
  function ua(e, t, n) {
  ...
  var da = 13,
    ...
    pa = 40,
    _a = 32;
  var ha = ["none", "shiny", "square", "circle", "rectangle_mat"];
  function va(e) {
    return e
  ...
  function ma() {
    var e = fr(
        (function () {
          if (
            "WordPress" === Ao.technology_name &&
            Ao.injectedData &&
            !Ao.is_connect
          ) {
            var e = Ao.injectedData.current_language,
              t = Ao.languages.find(function (t) {
                return t.language_to === e;
              });
            return (t && t.custom_code) || e;
          }
          return Ao.switcher_editor
            ? Ao.language_from
          ...
          var r,
            ...
            u =
              ...
              (s = r
                ...
                .join("\n\n")),
              !Ao.custom_css || Ao.switcher_gallery
                ? s
                : s + "\n\n" + Ao.custom_css);
          !(function (e, t) {
            if (e) {
  ...
  function ba(e) {
    ...
    function S(e) {
      if (Ao.switcher_editor) return s(!1);
      var t;
      o(e),
        (t = e),
        "WordPress" === Ao.technology_name && Ao.injectedData && !Ao.is_connect
          ? ft(t, function (e) {
    ...
    return (
      ...
      ),
      {
        ...
        handleKeyDown: function (e) {
          return e.keyCode === _a || e.keyCode === da
            ? (e.preventDefault(), p && S(p), E())
            : e.keyCode === pa || e.keyCode === ga
            ? (e.preventDefault(),
              void (function (e) {
                var t = e === pa ? "down" : "up",
                  n = d.slice(-1).pop(),
                  r = d[0],
                  a = va(u.current).bottom;
                void 0 === a && (a = 0);
                ...
                var i = "up" === t ? -1 : 1,
                  s = d.indexOf(p) + i;
                if (s === d.length || -1 === s) return;
                _(d[s]);
              })(e.keyCode))
            : void (e.keyCode === fa && l && (e.preventDefault(), E()));
        },
        switchLanguage: S,
        toggleOpen: E,
      }
  ...
  var ka = Yr("div")(function () {
    ...
    Ea = function (e) {
      ...
      if (
        !(
          ...
          "WordPress" !== Ao.technology_name &&
          !n &&
          !Ao.hide_switcher_watermark
        )
      )
        return null;
      var r =
        Ao.switcher_editor || Ao.visual_editor
          ? void 0
    ...
    Oa = function (e) {
      ...
      var f = t.with_flags,
        ...
        p = t.flag_type,
        _ = !!l && n === l,
        h = d ? ia(n) : n.toUpperCase(),
        v = s ? "div" : "li",
        m = ha.indexOf(p || "rectangle_mat"),
      ...
      return Ln(
        ...
        Ln(
          ...
          Object.assign(
            {},
            s ? { target: "_self" } : { role: "option" },
            { href: i },
            !c && { "aria-label": h },
            _ && !s && { ref: u },
            { id: "weglot-language-" + n, tabIndex: -1 }
          ),
          f && !a && Ln(Ca, { language: n, flagType: p, size_scale: g }),
          c && h
        )
      );
    };
  function Na(e) {
    ...
    return [
      ...
      },
      {
        ...
        declarations: {
          paddingRight: ua(22, n(40), 40) + "px",
          paddingLeft: ua(5, n(10), 10) + "px",
        },
      },
    ];
  }
  var Ta,
    ...
    Ra = (function (e, t) {
      return function (n) {
        ...
        !(function (e, t, n) {
          ...
          pn.__ && pn.__(e, t),
            ...
            $n(
              t,
              (e = t.__k = Ln(jn, null, [e])),
              r || En,
              En,
              t.namespaceURI,
              r ? null : t.firstChild ? gn.call(t.childNodes) : null,
              a,
          ...
          Ln(
            Zr,
            { logger: ra.error, displayError: !1 },
            Ln(e, {
      ...
      var k = t.is_dropdown,
        x = t.invert_flags,
        E = k || x,
        S = !k && n.hide_selected_language,
        C = Ot().filter(function (e) {
          return (!E && !S) || e !== l;
        }),
        O =
          /background-position/i.test(Ao.custom_css) &&
          !Ao.languages.some(function (e) {
      ...
      return v
        ? Ln(
            "aside",
            {
              ...
              onMouseEnter: d,
              onMouseLeave: f,
              className: "weglot_switcher country-selector default " + N,
              "aria-label": "Language selected: " + ia(l),
            },
            E &&
              !S &&
              Ln(Oa, {
  ...
  function Pa(e, t) {
    ...
    if (
      ...
      })(document.documentElement, "script#weglot-switcher-" + n))
    )
      return !1;
    var a = r ? n + "." + r : n,
    ...
    return (
      ...
      (i.src = "https://cdn.weglot.com/switchers/" + a + ".min.js"),
      (i.id = "weglot-switcher-" + n),
  ...
  function Da(e, t) {
    if ((void 0 === t && (t = document.documentElement), e && !e.ready)) {
      ...
      var a = (function (e, t) {
        ...
        u = a.defaultPosition;
      if (!o) {
        var c = Ra(Object.assign({}, e, { style: n }));
        if (((c.weglotSwitcher = e), Ia.push(c), u))
          return (
      ...
      te.warn(o, { sendToDatadog: !1 });
    }
  }
  function Fa() {
    Ta || ze("switchersReady", Ze()),
      (Ta = !0),
      clearTimeout(Aa),
      La && La.parentNode.removeChild(La);
  }
  function Ma(e) {
    if (
      (void 0 === e && (e = document),
      !(Ot().length < 2 || Ao.hide_switcher || Ao.switcher_editor))
    ) {
      ...
      if (n.length) {
        for (var r = 0, a = n; r < a.length; r += 1) {
          var o = a[r],
            i = Ra({ style: Ao.button_style });
          i.classList.add("weglot_here"), o.parentNode.insertBefore(i, o), l(o);
        }
        Fa();
      }
      for (var s = 0, u = Ao.switchers; s < u.length; s += 1) {
        var c = u[s];
        if (!c.default) {
          var d = c.template;
          if (d && "default" !== d.name) {
            if (d.name) {
              if (!Pa(d)) {
                var f =
                  window.Weglot.switchers && window.Weglot.switchers[d.name];
                f && f.addSwitchers(t);
              }
              Fa();
            }
      ...
      if (!Ta && !La) {
        var g = Ao.switchers.find(function (e) {
          return e.default;
        }) || { style: Ao.button_style };
        Aa = setTimeout(function () {
          (La = Da(g)), ze("switchersReady", Ze());
        });
      }
    }
  }
  qe(
    ...
    function () {
      Ia.forEach(function (e) {
        ...
        (Ta = null),
        (La = null),
        (Ao.button_style.ready = !1),
        Ao.switchers.map(function (e) {
          return (e.ready = !1);
        }),
        Ma();
    },
  ...
  function Ua() {
    var e = ["name", "value"];
    Ao.translate_event.forEach(function (t) {
      for (
              ...
              new MutationObserver(function (t) {
                for (var a = 0, o = t; a < o.length; a += 1) {
                  ...
                  e.includes(i.attributeName) &&
                    r.setAttribute(i.attributeName, l);
                }
              }).observe(n, { attributes: !0 });
            var i = Ie(function (e) {
              13 === e.keyCode && e.target.form
                ? e.target.form.dispatchEvent(new Event("submit"))
                : Xt(e.target.value, function (e) {
  ...
  try {
    var Ha = Element.prototype.attachShadow;
    Element.prototype.attachShadow = function (e) {
      var t = Ha.call(this, e);
      return qa([this]), t;
    };
  } catch (Ln) {}
  function qa(e) {
    if (Ao.translate_shadow_roots && e)
      for (var t = 0, n = e; t < n.length; t += 1) {
        var r = n[t];
        if (r.shadowRoot && !r.shadowRoot.wgTranslated) {
          (r.shadowRoot.wgTranslated = !0), Za(r.shadowRoot);
          var a = nn(r.shadowRoot);
          a.length &&
            (an(a),
            to(
              a.filter(function (e) {
    ...
    $a.length &&
      (za = setTimeout(function () {
        Ma(e),
                  ...
                  var r = n[t],
                    ...
                    o = function () {
                      ...
                      if (!S(e)) {
                        ...
                        if (t && t.includes("//" + Ao.host)) {
                          var n = t.split("//" + Ao.host)[1];
                          void 0 === n && (n = "/"),
                            Ct(void 0, n) ||
                              it(function (n) {
                                e.setAttribute("href", dt(Ze(), n, t));
                              });
                        }
                      }
                    },
          ...
          Ao.proxify_iframes &&
            Ao.proxify_iframes.length &&
            $a.forEach(function (e) {
              return cn({ node: e });
            }),
          qa($a),
          We("onDynamicDetected"),
          ($a = []);
      }, 100));
  }
  function Ya(e, t) {
    ...
    try {
            ...
            for (
              var r = [],
                a = function (e) {
                  ...
                  if (e.wgSetHTML !== n) {
                    for (
                      var a = nn(e, function (e) {
                          var n = e.element;
                          return (
                            !(function (e) {
                              if (e.weglot && e.weglot.dynamic > 20) {
                                if (e.wgBypassDynamicLimit) return !1;
                                if (Ao.dangerously_bypass_dynamic_limit) {
                                  var t = e.closest ? e : e.parentNode;
                                  if (
                                    Ne(t, Ao.dangerously_bypass_dynamic_limit)
                                  )
                      ...
                      var l = i[o];
                      (Ao.ignoreDynamicFragments &&
                        !document.body.contains(l)) ||
                        (l.weglot.dynamic || (l.weglot.dynamic = 0),
                        l.weglot.dynamic++,
                        r.push(l));
                    }
                    return null;
      ...
      te.warn(e, { consoleOverride: "Error in MutationObserver" });
    }
  }
  var Ka = !1;
  function Za(e) {
    var t = e !== document ? e : e.body || e,
      n = new MutationObserver(function (t) {
        ...
        if (Ka) Ya(t, e);
          ...
          var r = Ga.find(function (t) {
            return t.observedDocument === e;
          });
          r
            ? (n = r.mutations).push.apply(n, t)
            : Ga.push({ observedDocument: e, mutations: [].concat(t) });
        }
      });
    n.observe(t, {
      childList: !0,
  ...
  function Qa(e) {
    if (!Ao.dynamics || 0 === Ao.dynamics.length || !e) return !1;
    if (!e.closest) return Qa(e.parentNode);
    var t = !!Ne(
      e,
      Ao.dynamics
        .map(function (e) {
    ...
    return !t && e.getRootNode && e.getRootNode().host
      ? Qa(e.getRootNode().host)
      : t;
  }
  var eo = { times: [], timeout: null, nodes: [] };
  function to(e) {
    void 0 === e && (e = []), clearTimeout(eo.timeout);
    var t = function (e) {
        if ((e && !e.closest && (e = e.parentNode), !e)) return "unknown";
        for (var n = 0, r = Ao.dynamics; n < r.length; n += 1) {
          var a = r[n];
          if (Ne(e, a.value)) return a.value;
        }
      ...
      n = Ze();
    if (n !== Ao.language_from) {
      if (
        ((eo.times = eo.times.filter(function (e) {
          return e > Date.now() - 1e3;
        })),
        eo.times.length && (eo.timeout || eo.times.length >= 10))
      )
        return (
          (eo.nodes = eo.nodes.concat(e)),
          void (eo.timeout = setTimeout(function () {
            return to();
          }, 1e3))
        );
      e.forEach(function (e) {
        ...
        (eo.timeout = null),
        eo.times.push(Date.now());
      var r = eo.nodes.concat(e);
      return (
        (eo.nodes = []),
        Jt(on(r, { label: "Dynamic" }), n, {
          title: !1,
          cdn: !0,
          nodes: r,
        }).then(function (e) {
  ...
  function ro(e) {
    ...
    for (
      var s = 0, u = navigator.languages || [navigator.language];
      s < u.length;
      s += 1
    ) {
      var c = u[s],
        ...
        f = d.substring(0, 2);
      if (n[d]) return n[d];
      for (var g = 0, p = no; g < p.length; g += 1) {
        var _ = p[g],
          h = _.codes,
          v = _.pattern,
          m = h.find(function (t) {
  ...
  function ao() {
    if (window.location.search.indexOf("no_redirect=true") > -1) oo(Ze());
    else if (
      !(
        !Ao.auto_switch ||
        (Ao.subdirectory && Ao.injectedData) ||
        nt({ type: "cookie" }).getItem("WG_CHOOSE_ORIGINAL") ||
        je() ||
        Ao.visual_editor
      )
    ) {
      ...
      return e && !Ct(e)
        ? e
        : Ao.auto_switch_fallback && !Ct(Ao.auto_switch_fallback)
        ? Ao.auto_switch_fallback
        : void 0;
    }
  }
  function oo(e) {
    if (e === Ao.language_from) {
      var t = new Date();
      t.setTime(t.getTime() + 2592e6),
        nt({ type: "cookie" }).setItem("WG_CHOOSE_ORIGINAL", "1", {
          expires: t.toUTCString(),
        });
    } else nt({ type: "cookie" }).removeItem("WG_CHOOSE_ORIGINAL");
  }
  function io() {
    l(a(de));
  }
  ...
  var so = !1;
  function uo(e) {
    window.postMessage({ name: ne, data: e, target: le }, "*");
  }
  qe("languageChanged", function (e) {
    so && uo({ type: oe, payload: e });
  });
  var co = (function () {
    var e = function (e, t) {
    ...
    var n = t,
        ...
        var n = {},
          ...
          a = {
            ...
            dispatchEvent: function () {
              ...
              var i = a["on" + o];
              i && i.apply(a, n);
              for (var s = r(o).concat(r("*")), c = 0; c < s.length; c++)
                s[c].apply(a, n);
            },
            _has: function (e) {
              return !(!n[e] && !a["on" + e]);
      ...
      _ = function () {
          ...
          y = function (e) {
            for (; e > _ && _ < 4; )
              (b.readyState = ++_),
                ...
                4 === _ && (!1 === i.async ? m() : setTimeout(m, 0));
          },
          w = function (e) {
            if (4 === e) {
        ...
        b.addEventListener("error", k),
          ...
          (b.status = 0);
        for (var x = 0, E = Array.from(o.concat(a)); x < E.length; x += 1) {
          var S = E[x];
          b["on" + S] = null;
        }
        if (
          ((b.open = function (r, a, o, l, s) {
            (_ = 0),
              (e = !1),
              (t = !1),
              (i.headers = {}),
                  ...
                  return (function () {
                    for (
                      var e = 0,
                        n =
                          (s(o, r, b),
                          b.upload && s(o.concat(a), r.upload, b.upload),
                          (t = !0),
  ...
  function fo(e, t, n) {
    var r = t.target_source,
      ...
      i = {
        url_query: function (t, n) {
          return (
            void 0 === n && (n = e.url),
            {
              ...
              setter: function (r) {
                var a = new Ee(n, "https://" + window.location.hostname);
        ...
        url_encoded_form_payload: function (t, n) {
          void 0 === n && (n = e.body);
          var r = new Ee("https://unused.com?" + n).searchParams;
          return {
            word: r.get(t),
            setter: function (a) {
              r.set(t, a);
    ...
    return (function t(r, a, l) {
      ...
      if (!i[c] || r.length !== a.length) return Promise.resolve(l);
      var f = i[c](s, l),
        g = f.word,
        p = f.setter;
      return g
        ? u.length && d.length
          ...
          ? Promise.resolve(p(Je().convertLocale(Ao.language_from, g)))
          : "reverse_translate" === o
          ? new Promise(function (e) {
              return Xt(g, function (t) {
                return e(p(t));
              });
            })
          : Promise.resolve(l)
  ...
  function _o(e, t, n) {
    if (n || !e || window.top !== window || !mo(e)) {
      ...
      if (
        (e && t && !i && Tt(e),
        !Ao.is_connect || Ao.dynamicPushState || (!i && e !== Ao.language_from)
          ? (function (e) {
              void 0 === e && (e = !0);
              var t = Ao.excluded_blocks,
                n = Ao.is_connect;
              if ((Ka = e))
                if (
                  ((Ba =
                    ...
                    var r = function () {
                        var e = o[a],
                          ...
                          r = function () {
                            ...
                            e.length > 0 && (Ya(e, n), setTimeout(r, 0));
                          };
                        r();
                      },
                      a = 0,
          ...
          : (function () {
              if (0 !== Ja.length) {
                for (var e = 0, t = Ja; e < t.length; e += 1) t[e].disconnect();
                Ga = [];
              }
            })(),
        (a = Ao.xhr_hooks),
        (o = Ao.is_connect),
        !(a && Array.isArray(a) && a.some(po)) ||
          (o && Ct()) ||
          (co.enable(), co.before(go)),
        window.addEventListener("message", function (e) {
          if (e.data) {
            ...
            n === ne &&
              r === ie &&
              "library" === r &&
              ((so = !0), a.type === re && uo({ type: ae, payload: Ze() }));
          }
        }),
        n || i)
      )
        ...
        (Ao.is_connect && !i && We("onConnectPageLoad", e),
        Ao.force_translation)
      ) {
        for (var s = [], u = 0, c = r; u < c.length; u += 1) {
          var d = c[u],
            f = d.closest ? d : d.parentNode;
          Ne(f, Ao.force_translation) && s.push(d);
        }
        to(s);
      }
      (i && !i.language_button_displayed && i.allExcluded) || Ma(),
        i ||
          (Ao.remove_unused_link_hooks &&
            (function () {
              var e = Ot(),
                t = Ao.languages
                  .map(function (e) {
              ...
              1 === e.length && t.push(Ao.language_from);
              for (
                var n = t
                    .map(function (e) {
                      return wo(e);
          ...
          Ua(),
          (function () {
            window.addEventListener("message", fn, !1);
            var e = Ao.translate_iframes;
            if (e)
              for (var t = 0, n = Ce(document.body, e); t < n.length; t += 1) {
                var r = n[t];
                r.contentWindow && un.push(r.contentWindow);
              }
            cn({}),
              Me("onPageLanguageSet", dn),
              "with-window-top" === Ae() &&
          ...
          ["alert"].forEach(function (e) {
            ...
            window[e] = function () {
              ...
              if ("string" == typeof arguments[0]) {
                var n = Ze();
                return Ao.language_from === n
                  ? t.apply(window, arguments)
                  : Jt([{ t: 2, w: arguments[0] }], n, {
                      title: !1,
                      cdn: !0,
                    }).then(function (n) {
  ...
  function vo(e, t) {
    if (!Ot().includes(e))
      return (
        io(),
        void te.warn(e + " isn't a language you have added", {
          sendToDatadog: !1,
        })
      );
    (Ao.auto_switch || Ao.geo_auto_switch) && oo(e);
    var n = Ct();
    if ((Ao.is_connect || n || Tt(e), !mo(e))) {
      if (
        (Ao.loading_bar &&
          (function () {
            try {
      ...
      if (e === Ao.language_from)
        return (
          We("onPageLanguageSet", e),
          io(),
          ln(null, e),
          Ao.loading_bar && lo(),
          document.documentElement.setAttribute("lang", e),
          void ze("languageChanged", e, t || "")
        );
      Jt(on(), e)
        .then(function (n) {
          io(),
            ln(n, e),
            document.documentElement.setAttribute("lang", e),
            ze("languageChanged", e, t || ""),
            Ao.loading_bar && lo();
        })
        .catch(function (e) {
          throw (Ao.loading_bar && lo(), io(), nt().removeItem(ce), e);
        }),
        We("onPageLanguageSet", e);
    }
  }
  function mo(e) {
    return (
      !((!Ao.is_connect && "WordPress" !== Ao.technology_name) || Ze() === e) &&
      (!Ao.host ||
      (Ao.previewHash && window.location.hostname.includes(ue)) ||
      (function () {
        if (Ao.subdirectory) return [Ao.host].concat(d);
        return Ao.languages
          .map(function (e) {
            return (
  ...
  qe(
    ...
    function () {
      Ao.translate_search &&
        !Ao.switcher_editor &&
        (function () {
          var e = Ao.search_forms,
            t = Ao.search_parameter;
          if (t) {
            for (var n = 0, r = Ce(document, e); n < r.length; n += 1) {
              var a = r[n];
              a.addEventListener("submit", function (e) {
                e.preventDefault();
                var n = e.target.elements[t].value;
                Xt(n, function (e) {
                  ee.set({ name: "wg-search-form", value: n, options: Ao }),
              ...
              -1 !== window.location.search.indexOf(t + "=") &&
                a.elements &&
                a.elements[t] &&
                (o = ee.get("wg-search-form")) &&
                (a.elements[t].value = o);
            }
            ee.erase({ name: "wg-search-form", options: Ao });
          } else
            te.warn("Search parameter name required for search translation.", {
              sendToDatadog: !1,
            });
        })();
    },
  ...
  var yo = [];
  function wo(e) {
    var t = Ao.linkHooksConfig && Ao.linkHooksConfig.buildAdditionalSelectors;
    return [
      "a[href='#Weglot-" + e + "']",
  ...
  function bo(e) {
    ...
    var t =
      (Ao.linkHooksConfig && Ao.linkHooksConfig.additionalCheckSelectors) || [];
    if (
      0 !==
      Ce(
        e,
      ...
      for (var n = !1, r = 0, a = Ot(); r < a.length; r += 1) {
        var o = a[r],
          i = Ce(e, wo(o));
        if (0 !== i.length) {
          n = !0;
      ...
      return (
        ...
        qe("initialized", function () {
          var e = Ze();
          e !== Ao.language_from && ko(e);
        }),
        n
      );
    }
    ...
    yo.forEach(function (t) {
      ...
      r.forEach(function (e) {
        e.classList[o]("weglot-link--active"),
          Ao.linkHooksConfig &&
            Ao.linkHooksConfig[i] &&
            Ao.linkHooksConfig[i](e);
      });
    });
  }
  function xo(e, t) {
    var n = yo.find(function (t) {
      return t.language === e;
    });
    (n && -1 !== n.links.indexOf(t)) ||
      ...
      e === Ze() &&
        ...
        Ao.linkHooksConfig &&
          Ao.linkHooksConfig.onLinkActive &&
          Ao.linkHooksConfig.onLinkActive(t)),
      ft(e, function (e) {
  ...
  function Co(e, t) {
    if ((void 0 === t && (t = ""), !e)) return be.button_style;
    var n = e.classF || "",
      r = n.match(/flag-(\d)/),
      a = {
  ...
  function Oo(e) {
    var t = e.styleOpt,
      ...
      r = e.target,
      a = e.sibling;
    return { style: Co(t, n), location: { target: r, sibling: a } };
  }
  (Eo[me.shopify.id] = function () {
    return (
      Me("onWeglotSetup", function () {
        !1 !== Ao.original_shopify_checkout &&
          Ao.is_connect &&
          !Ao.subdirectory &&
          Ao.language_from === Ze() &&
          _t();
      ...
      qe(
        "initialized",
        function () {
          var e = nt({ type: "cookie" }).getItem("wg_checkout_redirect");
          e &&
            (nt({ type: "cookie" }).removeItem("wg_checkout_redirect"),
            nt({ type: "cookie" }).setItem("wg_checkout_language", e),
            ht(e)),
            window.langify &&
              te.log("%c Please, uninstall langify to properly use Weglot", {
                sendToDatadog: !1,
              }),
            !window.Shopify ||
              je() ||
              !Ao.order_tag ||
              (Ao.is_connect && Ao.language_from !== Ze()) ||
              bt(),
            vt();
          var t,
                ...
                if ("/wallets/checkouts.json" === arguments[0])
                  try {
                    ...
                    (e.checkout.attributes = {}),
                      Ao.cart_attributes &&
                        Ao.cart_attributes.forEach(function (t) {
      ...
      Me("onConnectPageLoad", function (e) {
        return kt(e);
      }),
        ...
        Me("onPageLanguageSet", function (e) {
          !(function (e) {
            for (
              ...
              var r = n[t];
              r.setAttribute("href", Pe(r.getAttribute("href"), "lang", e));
            }
          })(e);
        }),
        {}
    ...
    (Eo[me.webflow.id] = function () {
      return (
        qe("switchersReady", function () {
              ...
              if (e) {
                ...
                if (t) {
                  ...
                  if (n) {
                    ...
                    if (r && l)
                      (r.textContent = l.textContent), (l.textContent = o);
                    else {
                      var d = n.textContent;
  ...
  var No = [
    ...
    { from: "exceptions", to: "excluded_blocks", func: So },
    { from: "whiteList", to: "whitelist", func: So },
    { from: "styleOpt", to: "button_style", func: Co },
    {
    ...
    return (
      t.switchers &&
        ...
        t.switchers.length &&
          ...
          (t.switchers = t.switchers.map(Oo)),
        (t.scriptParamSwitcher = !0)),
      t.button_style && t.button_style.custom_css && (t.scriptParamStyle = !0),
  ...
  function jo(e) {
    ...
    return (function (e) {
      ...
      return fetch("" + se + e + ".json").then(function (e) {
        return e.json();
      });
    })(t)
      .then(function (e) {
        var t = e.custom_settings,
          r = Lo(e, ["custom_settings"]);
        ...
        var i = (function (e, t, n) {
            for (
              var r = Object.assign({}, e, t, n),
                a = 0,
                o = ["excluded_blocks", "dynamics"];
              a < o.length;
              a += 1
            ) {
              var i = o[a];
              r[i] = Array.from(
                new Set((e[i] || []).concat(t[i] || [], n[i] || []))
              );
            }
            return (
              r.dynamic &&
                ((r.dynamics = r.dynamics.concat(
                  r.dynamic.split(",").map(function (e) {
                    return { value: e.trim() };
                  })
                )),
                delete r.dynamic),
  ...
  function Ro() {
    var e = o();
    e && (delete e.settings, (Ao.injectedData = e));
  }
  function Po(e) {
    if (e.deleted_at)
      throw {
    ...
    if (
      (t &&
        ((e.previewHash = t),
        (e.is_dns_set = !0),
        (e.subdirectory = window.location.hostname.startsWith("subdir-"))),
      ...
      f(window.location.hostname) &&
        (window.location.hostname.includes("switchers") &&
          (Ao.switcher_editor = !0),
        (Ao.visual_editor = !0)),
      (Ao.private_mode = (function () {
        -1 !== location.search.indexOf("weglot-private=0") &&
          nt().removeItem("wg-private-mode");
        var e =
          ...
          f(window.location.hostname) ||
          "1" === nt({ type: "cookie" }).getItem("wg-private-mode");
        return e && nt({ type: "cookie" }).setItem("wg-private-mode", "1"), e;
      })()),
      !Ao.technology_id)
    ) {
      var n = e.technology_name || Ao.technology_name;
      n &&
        me[n] &&
        ((e.technology_id = me[n].id), (e.technology_name = me[n].name));
    }
    var r,
      a,
      o,
      l = (r = e.technology_id) ? Ht(Eo[r] ? Eo[r]() : {}, r) : {},
      s = Object.assign({}, be, l);
    if (
      (Object.assign(Ao, s, e),
      Ao.whitelist &&
        !Array.isArray(Ao.whitelist) &&
        (Ao.whitelist = String(Ao.whitelist)
          .split(",")
          .map(function (e) {
            return { value: e };
          })),
      ...
      (a = "https://cdn.weglot.com/weglot.min.css?v=9"),
      ((o = document.createElement("link")).rel = "stylesheet"),
      (o.type = "text/css"),
      (o.href = a),
      document.head.appendChild(o),
      (Ao.custom_css =
        Ao.custom_css || (Ao.button_style && Ao.button_style.custom_css) || ""),
      Ao.custom_css && i(Ao.custom_css, "weglot-custom-style"),
      Ao.switchers && 0 !== Ao.switchers.length
        ? (Ao.switchers = Ao.switchers.map(function (e) {
            var t = e.button_style,
              n = Lo(e, ["button_style"]);
            return Object.assign({}, { style: n.style || t }, n);
          }))
        : (Ao.switchers = [
            { style: Ao.button_style, location: {}, default: !0 },
          ]),
      Ao.api_key.length < 36 && (Ao.translation_engine = 1),
      Ao.excluded_blocks_remove &&
        (Ao.excluded_blocks = Ao.excluded_blocks.filter(function (e) {
          return !Ao.excluded_blocks_remove.includes(e.value);
        })),
      Ao.dangerously_force_dynamic &&
        (Ao.dynamics = Ao.dynamics.concat(
          Ao.dangerously_force_dynamic.split(",").map(function (e) {
            return { value: e.trim() };
          })
        )),
      Array.isArray(Ao.dangerously_bypass_dynamic_limit) &&
      ...
      (Ao.dynamics = Ao.dynamics.filter(function (e) {
        return Re(e.value);
      })),
      Ao.dynamics_remove &&
        (Ao.dynamics = Ao.dynamics.filter(function (e) {
          return !Ao.dynamics_remove.includes(e.value);
        })),
      (Ao.is_tld = !1),
      l.forceDisableConnect && (Ao.is_connect = !1),
      Ao.is_connect && !Ao.previewHash)
    ) {
      var u = Ao.host.split("www.").pop();
      Ao.is_tld = Ao.languages.some(function (e) {
        if (e.connect_host_destination && e.connect_host_destination.host)
          return -1 === e.connect_host_destination.host.indexOf(u);
      });
    }
    return (
      Ao.prevent_retranslation ||
        (Ao.prevent_retranslation = Ao.dynamics.some(function (e) {
          return "body" === e.value;
        })),
      (Ao.proxyFormat = _e),
      Ao.is_connect &&
        !Ao.disable_internal_proxy &&
        window.location.hostname !== ge &&
        (Ao.proxyFormat = pe),
      Array.isArray(Ao.force_translation) &&
        (Ao.force_translation = Ao.force_translation.join(",")),
      Ao
    );
  }
  var Io,
    ...
    Wo = !1;
  function Uo() {
    (Wo = !0), ze("polyfillReady");
  }
  function Ho() {
    return Wo;
  }
  function qo(e) {
    var t = "https://api.weglot.com/pageviews?api_key=" + Ao.api_key,
      n = JSON.stringify({
        url: e || Be().url,
        language: Ze(),
  ...
  !(function (e) {
    ...
    var t = Object.keys(Mo).filter(function (e) {
      return !Mo[e];
    });
    if (t.length) {
      !(function (e, t, n) {
  ...
  var zo = !1;
  function Bo() {
    window.addEventListener("message", Go, !1);
    var e = document.createElement("meta");
    (e.name = "google"),
      (e.content = "notranslate"),
      document.head && document.head.appendChild(e),
      document.documentElement &&
        -1 === ["cms.e.jimdo.com", ge].indexOf(window.location.host) &&
        -1 === window.location.pathname.indexOf("/wg-cgi/") &&
  ...
  function $o() {
    if (Ao.api_key) {
      qe(
        "initialized",
        function () {
          Ao.page_views_enabled &&
            (Ao.is_connect
              ? ft(Ao.language_from, function (e) {
                  return qo(e);
                })
              : qo());
        },
      ...
      if ((We("onWeglotSetup"), !Xo.initialized || window.Turbolinks)) {
        (Do = (function () {
          var e = Ot();
          if (Ao.is_connect) {
            var t =
              document.documentElement.dataset.wgTranslated ||
              (Ao.subdirectory ? Ye() : Xe());
            if (t !== Ao.language_from) return t;
            if (Ao.technology_name === me.shopify.name) {
              if (ee.get("wg_checkout_redirect")) return Ao.language_from;
              var n = ee.get("wg_checkout_language");
              if (n && !Ao.shopifyCheckout && !Ae() && e.includes(n))
                return (
                  ee.erase({ name: "wg_checkout_language", options: Ao }), n
                );
            }
            var r = ao();
            return t === Ao.language_from && r && e.includes(r)
              ? r
              : Ao.language_from;
          }
          var a = Le("lang");
          if (a && e.includes(a)) return (zo = !0), a;
          if (Ao.language_to && e.includes(Ao.language_to))
            return Ao.language_to;
          if (Ao.technology_name === me.wordpress.name) {
            var o = Ao.injectedData && Ao.injectedData.current_language;
            if (((o && e.includes(o)) || (o = Ke(e)), o === Ao.language_from)) {
              var i = ao();
              if (i && e.includes(i)) return (zo = !0), i;
            }
            return o || Ao.language_from;
          }
          var l = Nt();
          if (l && e.includes(l)) return l;
          var s = ao();
          if (s && e.includes(s)) return (zo = !0), s;
          return Ao.language_from;
        })()),
          Ze();
        var e = Ao.injectedData && Ao.injectedData.partial_translation,
          t = Ct();
        if (
          ((Fo =
            Do &&
            Do !== Ao.language_from &&
            (document.documentElement.dataset.wgTranslated !== Do || e) &&
            !t &&
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const priceAmount = document.querySelector('.price1 .amount');
  const pricePeriod = document.querySelector('.price1 .period');

  const updatePricing = () => {
    if (toggle.checked) {
      priceAmount.textContent = '$39.99';
      pricePeriod.textContent = '/Yearly (billed annually)';
    } else {
      priceAmount.textContent = '$49.99';
      pricePeriod.textContent = '/Monthly';
    }
  };

  // Update on load (in case toggle is pre-checked)
  updatePricing();
...
const tokens = [
  { name: "Dogecoin",     ticker: "DOGE",     logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/74.png",    price: "$0.2273",     change: "+4.9%" },
  { name: "Shiba Inu",    ticker: "SHIB",     logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/5994.png",  price: "$0.00001359", change: "+1.9%" },
  { name: "Pepe Coin",    ticker: "PEPE",     logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/11694.png", price: "$0.00001209", change: "+5.4%" },
  { name: "Bonk",         ticker: "BONK",     logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/21267.png", price: "$0.00003334", change: "+4.4%" },
  { name: "Pudgy Penguins",ticker:"PENGU",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/15012.png", price: "$0.03694",     change: "+6.5%" },
  { name: "Official Trump",ticker:"TRUMP",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/17612.png", price: "$9.85",        change: "+2.3%" },
  { name: "SPX6900",      ticker:"SPX",      logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/28081.png", price: "$1.72",        change: "+6.9%" },
  { name: "Dogwifhat",    ticker:"WIF",      logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/16939.png", price: "$0.2876",      change: "-1.2%" },
  { name: "Floki Inu",    ticker:"FLOKI",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/10646.png", price: "$0.000032",    change: "+8.4%" },
  { name: "Little Pepe",  ticker:"LILPEPE",  logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/19517.png", price: "$0.0014",      change: "+5.4%" },
  { name: "Fartcoin",     ticker:"FARTCOIN", logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/33597.png", price: "$1.27",        change: "-2.5%" },
  { name: "Snek",         ticker:"SNEK",     logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/25264.png", price: "$0.0051",      change: "+3.6%" },
  { name: "Gigachad",     ticker:"GIGA",     logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/30063.png", price: "$0.01949",     change: "+10.1%" },
  { name: "MemeCore",     ticker:"M",        logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/35491.png", price: "$0.3537",      change: "+15.7%" },
  { name: "Pump.fun",     ticker:"PUMP",     logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/16204.png", price: "$0.002523",    change: "+11.6%" },
  { name: "Turbo",        ticker:"TURBO",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/24911.png", price: "$0.00084",     change: "+6.8%" },
  { name: "Pawthereum",   ticker:"PAWTH",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/12983.png", price: "$0.00022",     change: "-3.4%" },
  { name: "ChillGuy",     ticker:"CHILLGUY", logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/34125.png", price: "$0.0073",      change: "+2.6%" },
  { name: "NPC",          ticker:"NPC",      logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/27960.png", price: "$0.0094",      change: "+4.7%" },
  { name: "Simon's Cat",  ticker:"CAT",      logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/32724.png", price: "$0.0111",      change: "-0.5%" },
  { name: "Moo Deng",     ticker:"MOODENG",  logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/33093.png", price: "$0.0046",      change: "+1.3%" },
  { name: "Act I Prophecy",ticker:"ACT",     logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/33566.png", price: "$0.0065",      change: "-2.1%" },
  { name: "Brett",        ticker:"BRETT",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/29743.png", price: "$0.0847",      change: "+12.0%" },
  { name: "Popcat",       ticker:"POPCAT",   logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/28782.png", price: "$0.0321",      change: "+5.8%" },
  { name: "Baby Doge Coin",ticker:"BABYDOGE",logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/10407.png", price: "$0.00000012",  change: "+0.9%" },
  { name: "Pork (PepeFork)",ticker:"PORK",   logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/29220.png", price: "$0.00085",     change: "-1.1%" },
  { name: "HYPER",        ticker:"HYPER",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/36281.png", price: "$0.0021",      change: "+3.3%" },
  { name: "T6900",        ticker:"T6900",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/36281.png", price: "$0.0007",      change: "+0.7%" },
  { name: "Melania (LIBRA)",ticker:"LIBRA",  logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/35347.png", price: "$0.0093",      change: "-90.0%" },
  { name: "Cats in Dog's World",ticker:"MEW",logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/33646.png", price: "$0.0042",      change: "+4.4%" },
  { name: "UPEPE",        ticker:"UPEPE",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/26606.png", price: "$0.00047",     change: "+1.2%" },
  { name: "SolanaDoge",   ticker:"SOLDOGE",  logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/32989.png", price: "$0.00065",     change: "-2.0%" },
  { name: "DegenToken",   ticker:"DEGEN",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/26075.png", price: "$0.0092",      change: "+7.5%" },
  { name: "MoonWolf",     ticker:"MWOLF",    logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/9158.png",  price: "$0.0013",      change: "-0.8%" },
  { name: "PupperCoin",   ticker:"PUP",      logo: "https://ipfs.sintral.me/cdn-cgi/image/width=480,quality=100,format=webp/ipfs/QmWNmuws7ipHWxJTQ1v8qnX5YBtBw3q5UK2QBisXYVFxcp", price: "$0.00075", change: "+3.1%" },
  { name: "CatToken",     ticker:"CATGIRL",  logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/22950.png", price: "$0.00000067",  change: "+2.0%" },
  { name: "DogKitty",     ticker:"DKC",      logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/25241.png", price: "$0.00041",     change: "+0.5%" },
  { name: "PepeLaugh",    ticker:"LAUGH",    logo: "https://ipfs.sintral.me/cdn-cgi/image/width=480,quality=100,format=webp/ipfs/QmeobPoaJpf3yLVJsYH9aHQMca88wGmeaPqhaTmy2EduyZ", price: "$0.0027", change: "-0.3%" },
  { name: "MemeFi",       ticker:"MEMEFI",   logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/33464.png", price: "$0.00092",     change: "+1.9%" },
  { name: "SpaceDoge",    ticker:"SPDOGE",   logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/28872.png", price: "$0.00025",     change: "+4.6%" },
  { name: "Classic Doge", ticker:"C_DOGE",   logo: "https://s2.coinmarketcap.com/static/img/coins/64x64/6553.png",  price: "$0.0011",      change: "+3.2%" },
];


 tokens.forEach(token => {
  token.isPositive = token.change.trim().startsWith("+");
});
...
function createTickerItem(token) {
  ...
  item.innerHTML = `
    ...
    <div class="change ${token.isPositive ? "positive" : "negative"}">${token.change}</div>
  `;
  return item;
}

function populateTicker(trackId) {
  const track = document.getElementById(trackId);
  const fullList = [...tokens, ...tokens]; // Duplicate once for seamless scroll
  fullList.forEach(token => {
    track.appendChild(createTickerItem(token));
  });
}

populateTicker("tickerTrack1");
populateTicker("tickerTrack2");
populateTicker("tickerTrack3");
          ...
          case "Weglot.detect":
            e.source.postMessage(
              JSON.stringify({
                ...
                data: { initialized: Xo.initialized, options: Ao },
              }),
              e.origin
            );
            break;
  ...
  var Xo = window.Weglot || {
    ...
    translate: function (e, t) {
      ...
      if (
        ...
        return (
          te.error(a, { sendToDatadog: !1 }), t && t(null, a), Promise.reject()
        );
      }
      return r === Ao.language_from
        ? (t &&
    ...
    getBestAvailableLanguage: ro,
    getAvailableLanguages: Ot,
  };
  return (
    He(Ho(), "polyfillReady", function () {
      Za(document);
      for (
        ...
        if (r) {
          var a = Jo(r);
          if (a) return void Xo.initialize(a);
        }
      }
    }),
    Xo
